...
beta = 0.03  # regularization coefficient
alpha = 0.4  # step size coefficient
...
def computeCost(X, y, theta, beta):  # loss is Bernoulli cross-entropy/log likelihood
    ############################################################################
    mu = regress(X, theta)
...
# write code to turn X_feat into a polynomial feature map
...
while i < n_epoch and halt == 0:
    ...
    ############################################################################
    # perform a check for convergence (or simply to halt early)
    ############################################################################
...
############################################################################
# apply feature map to input features x1
# turn X_feat into a polynomial feature map
############################################################################
...
# PLOTTING
############################################################################
plt.savefig('out/prob2_fit_Q1Scatterplot15.png')
plt.show()
